...
ALLOWED_RE='^(AGENTS\.md|ROADMAP\.md|STATUS\.md|NOTICE\.md|UPSTREAM_SYNC\.md|UPSTREAM_TOUCHPOINTS\.md|BLOCKED\.md|HANDOVER\.md|GAP_ANALYSIS\.md|evidence/|scripts/touchpoint_guard\.sh|scripts/upstream_sync\.sh|\.github/workflows/upstream-sync\.yml|app/src/fdroid/res/|app/src/play/res/|app/src/main/java/com/newoether/agora/autopilot/|app/src/test/java/com/newoether/agora/autopilot/|app/src/androidTest/java/com/newoether/agora/autopilot/)'
